...
namespace Sample.HueBot.Bot
{
    ...
    public class Bot
    {
        ...
        /// </returns>
        internal IEnumerable<string> GetLogsByCallId(string callId, int limit)
        {
            return this.GetHandlerOrThrow(callId).OutcomesLogMostRecentFirst.Take(limit);
        }
        ...
        private void CallsOnUpdated(ICallCollection sender, CollectionEventArgs<ICall> args)
        {
            ...
            {
                this.CallHandlers.GetOrAdd(call.Id, new CallHandler(call, this.logger));
            }
